...
eps = 1E-2
tfinal = 0.58E-3
step_stop = int(100000)
step_save = step_stop/5
...
print(json.dumps({
		    ...
		    # Patch 1: High pressured water ============================
                    ...
                    'patch_icpp(1)%vel(1)'         : -500.E+00,                
                    'patch_icpp(1)%pres'           : 1.E+05,                   
                    'patch_icpp(1)%alpha_rho(1)'   : 1150.E+00*(1.-eps),       
                    'patch_icpp(1)%alpha_rho(2)'   : 0.63E+00*eps,             
                    ...
                    'patch_icpp(2)%length_x'       : 0.50E+00,                 
                    'patch_icpp(2)%alter_patch(1)' : 'T',                      
                    'patch_icpp(2)%vel(1)'         : 500.E+00,                 
                    'patch_icpp(2)%pres'           : 1.E+05,                   
                    'patch_icpp(2)%alpha_rho(1)'   : 1150.E+00*(1.-eps),       
                    'patch_icpp(2)%alpha_rho(2)'   : 0.63E+00*eps,             
		    ...
		    # Fluids Physical Parameters ===============================
                    ...
                    'fluid_pp(1)%cv'               : 1816E+00,                 
                    'fluid_pp(1)%qv'           	   : -1167E+03,                
                    'fluid_pp(1)%qvp'              : 0.E+00,                   
                    'fluid_pp(2)%gamma'            : 1.E+00/(1.43E+00-1.E+00), 
                    'fluid_pp(2)%pi_inf'           : 0.E+00,                   
                    'fluid_pp(2)%cv'               : 1040E+00,                 
                    'fluid_pp(2)%qv'               : 2030E+03,                 
                    'fluid_pp(2)%qvp'              : -23.4E+03,                
	            # ==========================================================
}))
# ==============================================================================
